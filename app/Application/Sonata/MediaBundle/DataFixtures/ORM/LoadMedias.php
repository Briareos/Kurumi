...
class LoadMedias extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    private $container;
    ...
    function load(ObjectManager $manager)
    {
        ...
        foreach ($genders as $genderName => $avatarDirectory) {
            ...
            foreach ($avatarFinder->in($avatarDirectory)->files() as $avatarFile) {
                ...
                $avatarMedia->setBinaryContent($avatarFile->getContents());
